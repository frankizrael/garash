(function ($, app) {
	...
	WpfFrontendPage.prototype.chageRangeFieldWidth = (function () {
		var _thisObj = this.$obj,
			input1 = jQuery('body').find('#wpfMinPrice'),
			input2 = jQuery('body').find('#wpfMaxPrice'),
			fontSize1 = input1.css('font-size'),
			fontSize2 = input2.css('font-size'),
			buffer1 = jQuery('body').find('.input-buffer-min'),
			buffer2 = jQuery('body').find('.input-buffer-max');
	...
	WpfFrontendPage.prototype.eventsFrontend = (function () {
		...
		jQuery('body').on('click','.wpfFilterWrapper .wfpTitle', function(){
