...
//		frameWpf::_()->addScript('jquery.slider.js', $this->getModule()->getModPath(). 'js/jquery.slider.min.js');
	...
	public function generateFilterHeaderHtml($filter, $filterSettings) {
		...
		if($title) {
			...
			$html .= '<div class="wfpTitle'.($this->getFilterSetting($filterSettings['settings'], 'hide_filter_icon', 0) ? ' wfpClickable' : '').'">'.$title.'</div>' . $icon;
		}
		...
		$html .= '<div class="wpfFilterContent' . ($enableTitle == 'yes_close' ? ' wpfHide' : '') . '">';
