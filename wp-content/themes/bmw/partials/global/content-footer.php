    ...
    <div class="footer__content x-container">
        <div class="list">
            ...
            <div class="list__item">
                ...
                <ul>
                    <li><a href="">(+51) 01 512 1515</a></li>
                    <li><a href="">Lunes - viernes, 9.00 - 18.00</a></li>
                </ul>
                <a href="" class="book">
                    <i>
        ...
        <div class="addresses">
            <div class="addresses__item">
                ...
                <p>
                    Av. El Polo 1117 Surco LIMA, 33
                </p>
            </div>
            <div class="addresses__item">
                <div class="title">BMW LifeStyle San Isidro</div>
                <p>
                    Av. Andrés Aramburú 1105 San Isidro 15036
                </p>
            </div>
            <div class="addresses__item">
                <div class="title">BMW LifeStyle Jockey Plaza</div>
                <p>
                    C.C. Jockey Plaza Av. Jav. Prado Este 4200 Santiago de Surco 15023
                </p>
            </div>
            <div class="addresses__item">
                <div class="title">BMW LifeStyle Arequipa</div>
                <p>
                    Mall Plaza Arequipa Av. Ejército 793 Local I-03 Cayma 04000
                </p>
            </div>
        </div>
    </div>
